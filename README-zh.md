...
## 配置
配置存储在程序运行目录的一个名为cmcl.json的JSON文件，你可以使用文本编辑器（需了解JSON教程）或`-config <配置名称> <配置值>`的程序参数（详见 [使用教程配置相关](#配置相关)）以修改配置。</br>
...
&emsp;&emsp;获得使用手册：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;-u</br>
&emsp;&emsp;启动选择的版本：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 无参数直接运行 或 -b</br>
&emsp;&emsp;启动特定的版本：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 唯一参数：<版本名称> 或 -b <版本名称></br>
&emsp;&emsp;列出所有版本：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;-l</br>
&emsp;&emsp;列出某个游戏目录的所有版本：-l <目标游戏目录></br>
&emsp;&emsp;打印启动命令：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;-p <版本名称></br>
&emsp;&emsp;选择版本：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;-s <版本名称></br>
&emsp;&emsp;获得关于信息：&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;-a</br>
### 配置相关
...
&emsp;&emsp;外置账号登录：   -account -l -a -d <服务器地址> -s(可选，登录成功后选择此账号)</br>
...
### 安装版本相关
&emsp;&emsp;直接安装版本：-install <版本名称（如果有空格要加双引号）> -n <存储的版本名称(可选)> -f(可选，安装Fabric)</br>
...
### 模组相关（CurseForge）：
&emsp;&emsp;搜索模组并安装：&emsp;&emsp;-mod -i <模组名称></br>
&emsp;&emsp;搜索模组并显示信息：-mod -s <模组名称>
